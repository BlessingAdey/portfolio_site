  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w mx-auto">
        ...
        >
          <img src={logo} alt="logo" className="w-9 h-9  logo" />
          <p className="sm:block text-white text-[16px] font-bold cursor-pointer flex ">
            Blessing.Adey
          </p>
        </Link>
        ...
        <div className="sm:flex gap-5">
          ...
          >
            ...
            <a
              href="https://cal.com/blessingadey/web-discussion"
              target="_blank"
            >
              Schedule a meeting
            </a>
