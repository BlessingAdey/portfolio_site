        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hi there, I'm{" "}
              <p className="name text-[#915EFF]">Blessing Adesuyi</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a href="https://github.com/BlessingAdey" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/adebola-adesuyi-817030293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
              >
                <ImLinkedin />
              </a>
              <a
                href="https://www.instagram.com/ini_nimi?igsh=aWZ3c2VpOW03Nmwz"
                target="_blank"
              >
                <AiOutlineInstagram />
              </a>
              <a
                href="https://www.facebook.com/share/v/1B59RvcrF6/"
                target="_blank"
              >
                <BiLinkAlt />
              </a>
